...
class FusionSC_Progressbar {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s></div><span %s>%s %s%s</div>', FusionCore_Plugin::attributes( 'progressbar-shortcode' ), FusionCore_Plugin::attributes( 'progressbar-shortcode-content' ),
