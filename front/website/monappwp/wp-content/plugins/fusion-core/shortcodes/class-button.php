...
class FusionSC_Button {
    ...
    function attr() {
        ...
        $attr['class'] = sprintf( 'btn-default button %3$s button %4$s fusion-button button-%s button-%s button-%s button-%s button-%s buttonshadow-%s', self::$args['type'], self::$args['shape'], self::$args['size'], self::$args['color'], $this->button_counter, self::$args['shadow'] );
