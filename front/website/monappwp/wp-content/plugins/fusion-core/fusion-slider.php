	...
	class Fusion_Slider {
			...
			if( ! $smof_data['status_fusion_slider'] ) {
				...
				register_taxonomy('slide-page', 'slide',
					array(
						...
						'show_tagcloud' => false,
						'labels' => array(
							'name'                       => _x( 'Sliders', 'Taxonomy General Name', 'fusion-core' ),
							'singular_name'              => _x( 'Slider', 'Taxonomy Singular Name', 'fusion-core' ),
							'menu_name'                  => __( 'Add or Edit Sliders', 'fusion-core' ),
							'all_items'                  => __( 'All Sliders', 'fusion-core' ),
							'parent_item'                => __( 'Parent Slider', 'fusion-core' ),
		...
		function admin_init() {
			...
			if( ( isset( $_GET['taxonomy'] ) && $_GET['taxonomy'] == 'slide-page' ) || ( isset( $_GET['post_type'] ) && $_GET['post_type'] == 'slide' ) || $post_type == 'slide' ) {
				wp_enqueue_script( 'fusion-slider', plugin_dir_url( __FILE__ ) . 'js/fusion-slider.js', false, '1.0', false );
			}
